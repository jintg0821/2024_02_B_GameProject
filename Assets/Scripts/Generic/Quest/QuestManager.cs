...
public class QuestManager : Singleton<QuestManager>
{
    ...
    private void InitializeQuests()
    {
        ...
        //약초 수집 퀘스트
        var herbQuest = new Quest("Q002", "Herb Collection", "Collection hurbs for the healer", QuestType.Collection, 1);
        ratHuntQuest.AddCondition(new CollectionQuestCondition("Herb", 3));
        ratHuntQuest.AddReward(new ExperienceReward(50));
    ...
    public bool CanStartQuest(string questId)       //특정 퀘스트를 시작할 수 있는지 검사하는 메서드
    {
        ...
        //List<string> prerequisiteQuestIds = prerequisiteIdsValue as List<string>;     //List로 변환하고
    ...
    private void CompleteQuest(string questId)
    {
        ...
        quest.Complete(player);                 //player가 null 이어도 진행되도록 함
